...
import '../relatorios/relatorios-adm.css'; // Import the CSS file
...
function RelatoriosAdm() {
  ...
  return (
    <div className="relatorios-adm-container">
      <h2 className="relatorios-title">Relatórios de Processos</h2>
